...
textbox_y_Shift = 0;
//draw_text(camera_get_view_x(view_camera[0])+8,camera_get_view_y(view_camera[0] )+16,string(obj_Player.y - camera_get_view_y(view_camera[0])))
if(obj_Player.y - camera_get_view_y(view_camera[0]) > 160)
	{
		//textbox_y = camera_get_view_y(view_camera[0] ) + 16;
		textbox_y_Shift = 16-160;
	}
